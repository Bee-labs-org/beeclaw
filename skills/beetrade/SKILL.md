---
name: beetrade
description: Use the Beecli CLI to interact with the Beetrade trading platform. Supports authentication, bot management, market data, portfolio analysis, trading operations, strategies, alerts, brokerages, and accounts.
metadata:
  {
    "beecli":
      {
        "requires": { "bins": ["beecli"] },
        "install":
          [
            {
              "id": "node",
